...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_passwords_do_not_match(self):
        def callback(form):
            ...
            confirm_password = self.get_by_placeholder(
                form, 'Repeat your password')
            password.send_keys('P@ssw0rd')
            confirm_password.send_keys('P@ssw0rd_Different')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, 'Ex.: Doe').send_keys('Name')
        ...
        self.assertIn('Your user has been created, please log in', body)
